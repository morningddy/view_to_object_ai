...
![产品渲染演示](assets/demo_sneaker.png)

**左上：Blender 中一个简单的鞋子模型 → 面板设置低重绘强度(0.10) + 赛博朋克风格 → 底部：AI 生成电影级产品广告图（闪电、岩石、水面倒影）**
...
| 6 | **双平台兼容** | 本地 SD WebUI + 各种 API(fal-ai 兼容) |
...
| **各种 API** | fal-ai 兼容转发站 | Wan 2.2 / Flux Dev / SD3 / gpt-image-2 等 |
